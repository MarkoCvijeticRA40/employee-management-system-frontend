...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'profile', component: ProjectManagerProfileComponent },
  ...
  },
  {
    ...
    children: [{ path: 'home', component: HrManagerHomeComponent }],
  },
  {
    ...
    children: [
      ...
      { path: 'profile', component: SoftwareEngineerProfileComponent },
